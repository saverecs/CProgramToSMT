...
{       
  ...
  // plant states
  double engine_speed = input->p_engine_speed;
  double throttle_angle = input->p_throttle_angle;
  double throttle_flow = input->p_throttle_flow;
  double airbyfuel_meas = input->p_airbyfuel_meas;
  ...
  ret_val->c_commanded_fuel_gps = commanded_fuel_gps;
